...
const EnvSchema = z.object({
  ...
  // URL pública do player/embed (SCORM, iframe). Se não definido, usa BASE_URL ou Origin do request. Nunca localhost em produção.
  ...
  VIMEO_REDIRECT_URI: z.union([z.string().url(), z.literal("")]).optional(),
  ...
  LTI_PLATFORM_AUTH_LOGIN_URL: z.union([z.string().url(), z.literal("")]).optional(),
  LTI_PLATFORM_KEYSET_URL: z.union([z.string().url(), z.literal("")]).optional(),
